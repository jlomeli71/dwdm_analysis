...
LAMBDA_PATHS = [
...

    {
        ...
        "segments": [
            {"sites": ("NFO-038", "NFO-076"), "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-076", "NFO-075"), "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-075", "NFO-025"), "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-025", "NFO-044"), "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("NFO-044", "NFO-027"), "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("NFO-027", "NFO-006"), "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("NFO-006", "NFO-117"), "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-117", "MSOTOL01"), "fiber": "ruta_1", "fiber_provider": "AT&T"},
        ],
    },
    {
    ...
    },
    {
        ...
        "capacity_per_lambda": 100, "protection_route": None,
        "segments": [
            {"sites": ("NFO-038", "NFO-076"),  "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("NFO-075", "NFO-076"),  "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("NFO-022", "NFO-075"),  "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("NFO-022", "NFO-053"),  "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("MSOPUE01", "NFO-053"), "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("MSOPUE01", "NFO-010"), "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("MSOMEX04", "NFO-010"), "fiber": "ruta_1", "fiber_provider": "Unknown"},
        ],
    },
    {
...

    {
        ...
        "segments": [
            ...
            {"sites": ("NFO-022", "NFO-053"),    "fiber": "ruta_1", "fiber_provider": "Maxcom"},
            {"sites": ("MSOPUE01", "NFO-053"),   "fiber": "ruta_1", "fiber_provider": "Maxcom"},
            {"sites": ("MSOPUE01", "NFO-010"),   "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("MSOMEX04", "NFO-010"),   "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("MSOMEX04", "MSOTOL01"),  "fiber": "ruta_1", "fiber_provider": "AT&T"},
        ],
    },
    {
        ...
        "segments": [
            ...
            {"sites": ("NFO-004", "NFO-009"),    "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("MSOMEX04", "NFO-004"),   "fiber": "ruta_1", "fiber_provider": "AT&T"},
    ...
    },
    {
        ...
        "segments": [
            ...
            {"sites": ("NFO-025", "NFO-075"),    "fiber": "ruta_1", "fiber_provider": "Marcatel"},
            {"sites": ("NFO-009", "NFO-025"),    "fiber": "ruta_1", "fiber_provider": "Marcatel"},
            {"sites": ("NFO-009", "NFO-040"),    "fiber": "ruta_1", "fiber_provider": "Bestel"},
    ...
    },
    {
        ...
        "segments": [
            {"sites": ("NFO-022", "TAMREY1273"), "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-022", "NFO-075"),    "fiber": "ruta_1", "fiber_provider": "Marcatel"},
            {"sites": ("MSOMTY02", "NFO-075"),   "fiber": "ruta_1", "fiber_provider": "AT&T"},
    ...
    },
    {
        ...
        "capacity_per_lambda": 100, "protection_route": None,
        "segments": [
            {"sites": ("MSOTOL01", "NFO-004"),  "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-004", "NFO-009"),   "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-009", "NFO-040"),   "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("NFO-032", "NFO-040"),   "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("MSOGDL02", "NFO-032"),  "fiber": "ruta_1", "fiber_provider": "Bestel"},
    ...
    },
    {
        ...
        "capacity_per_lambda": 100, "protection_route": None,
        "segments": [
            {"sites": ("MSOMTY01", "MSOMTY02"), "fiber": "ruta_1", "fiber_provider": "Unknown"},
            ...
            {"sites": ("MSOPUE01", "NFO-010"),  "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("MSOMEX04", "NFO-010"),  "fiber": "ruta_1", "fiber_provider": "Unknown"},
            {"sites": ("MSOMEX01", "MSOMEX04"), "fiber": "ruta_2", "fiber_provider": "Unknown"},
        ],
    },
...

    {
        ...
        "capacity_per_lambda": 100, "protection_route": None,
        "segments": [
            {"sites": ("MSOJRZ01", "NFO-027"), "fiber": "ruta_1", "fiber_provider": "QUATTROCOM"},
            {"sites": ("NFO-027", "NFO-044"),  "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("NFO-044", "NFO-076"),  "fiber": "ruta_1", "fiber_provider": "AT&T"},
    ...
    },
    {
        ...
        "segments": [
            ...
            {"sites": ("NFO-032", "NFO-040"),  "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("MSOMEX04", "NFO-040"), "fiber": "ruta_1", "fiber_provider": "Bestel"},
    ...
    },
    {
        ...
        "segments": [
            ...
            {"sites": ("NFO-006", "NFO-027"),  "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("NFO-006", "NFO-009"),  "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("NFO-004", "NFO-009"),  "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("MSOTOL01", "NFO-004"), "fiber": "ruta_1", "fiber_provider": "AT&T"},
        ],
    },
...

    {
        ...
        "segments": [
            {"sites": ("KIO-QRO", "NFO-040"),   "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("MSOMEX04", "NFO-040"),  "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("MSOMEX01", "MSOMEX04"), "fiber": "ruta_2", "fiber_provider": "AT&T"},
        ],
    },
    {
        ...
        "segments": [
            {"sites": ("KIO-QRO", "NFO-009"),   "fiber": "ruta_1", "fiber_provider": "Bestel"},
            {"sites": ("NFO-004", "NFO-009"),    "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("MSOMEX04", "NFO-004"),   "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("MSOMEX01", "MSOMEX04"),  "fiber": "ruta_2", "fiber_provider": "AT&T"},
        ],
...

    {
        ...
        "segments": [
            {"sites": ("CIRION-ZURICH", "MSOMEX01"), "fiber": "ruta_1", "fiber_provider": "Cirion"},
        ],
    },
    {
        ...
        "capacity_per_lambda": 100, "protection_route": None,
        "segments": [
            {"sites": ("CIRION-ZURICH", "MSOMEX01"), "fiber": "ruta_2", "fiber_provider": "Cirion"},
            {"sites": ("MSOMEX01", "NFO-004"),       "fiber": "ruta_1", "fiber_provider": "AT&T"},
            {"sites": ("MSOTOL01", "NFO-004"),       "fiber": "ruta_1", "fiber_provider": "AT&T"},
        ],
    },
    {
        "name": "Cirion Humboldt to Apodaca", "color": "#B22222", "num_lambdas": 1,
        "capacity_per_lambda": 100, "protection_route": "Cirion Humboldt to Buenos Aires",
        "segments": [
            {"sites": ("CIRION-HUMBOLDT", "MSOMTY01"), "fiber": "ruta_1", "fiber_provider": "Cirion"},
        ],
    },
    {
        "name": "Cirion Humboldt to Buenos Aires", "color": "#B87333", "num_lambdas": 1,
        "capacity_per_lambda": 100, "protection_route": "Cirion Humboldt to Apodaca",
        "segments": [
            {"sites": ("CIRION-HUMBOLDT", "MSOMTY02"), "fiber": "ruta_1", "fiber_provider": "Cirion"},
        ],
    },
    {
        "name": "Cirion Mirlo to Tlaquepaque", "color": "#FF2400", "num_lambdas": 1,
        "capacity_per_lambda": 100, "protection_route": None,
        "segments": [
            {"sites": ("CIRION-MIRLO", "MSOGDL01"), "fiber": "ruta_1", "fiber_provider": "Cirion"},
        ],
    },
]
